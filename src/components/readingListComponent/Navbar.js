...
const Navbar = ()=>{
    ...
    return(
        <div className='flex justify-center pt-10'>
            ...
            <p className='text-center text-white pt-2 text-sm'>Currently you have <span className='font-bold px-2  border-white border rounded-full'>{books.length}</span>  to get through...</p>
            </div>
        </div>
    )
}
